...
export function DeadlineCard({
  ...
  return (
    <li className="flex items-center justify-between gap-3 rounded border border-gray-200 px-4 py-3 dark:border-gray-800">
      <div>
      ...
      <form action={toggleComplete.bind(null, deadline.id)} className="shrink-0">
        <button
          type="submit"
